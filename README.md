...
- Run the `Navigation_Demo.ipynb` to observe the (trained) agent in action. No training is performed in this file.

### References and Acknowledgments

This file is a slightly modified version of the corresponding file in the first project of the Deep Reinforcement Learning Nanodegree,  https://www.udacity.com/course/deep-reinforcement-learning-nanodegree--nd893
